...
const defaultHandler = console.log;

exports.createLogger = (level, handler = defaultHandler) => {
...
exports.parseLevel = (options) => {
	if(options.log) return normalizeLevel(options.log);
